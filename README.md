...
Este repositório é um **fork do projeto original de Gustavo Pavanelli**, com o objetivo de **continuar e finalizar o desenvolvimento do sistema que eu havia começado em grupo para um trabalho de gerenciamento de Sofware**, porém com alterações e melhorias independentes do repositório principal.
